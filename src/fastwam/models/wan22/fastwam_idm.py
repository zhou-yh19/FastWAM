...
from .fastwam import randn_like_with_generator, resolve_training_timestep
...
class FastWAMIDM(FastWAMJoint):
    ...
    def training_loss(
        ...
        """See `FastWAM.training_loss` for the meaning of the optional pinning arguments."""
        ...
        ) < float(self.video_cond_noise_prob)
        ...
        if bool(cond_noise_mask.any()):
            ...
            noise_video_cond = randn_like_with_generator(input_latents, generator)
